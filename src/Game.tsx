...
function randomTarget(wordLength: number): string {
  ...
  let candidateArray = candidate.split("");
  const letter = candidateArray[letterToChange];
  const currentLetter = alphabet.findIndex((l) => l === letter);
